...
- **iOS**: از iOS 12.0 تا iOS 26+ پشتیبانی می‌کند (حداکثر سازگاری). 📱
...
5. **iOS 12.0+**: حداکثر سازگاری با ~99% دستگاه‌های iOS فعال
...
- iOS: به iOS 12.0 deployment target تنظیم شد (iOS 12 تا iOS 26+ پشتیبانی)
