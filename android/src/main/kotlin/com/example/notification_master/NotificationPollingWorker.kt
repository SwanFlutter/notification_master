...
class NotificationPollingWorker(
    ...
    companion object {
        ...
        fun schedulePolling(
            ...
            // Create constraints for the worker with battery optimization
            val constraints = Constraints.Builder()
                .setRequiredNetworkType(NetworkType.CONNECTED) // فقط زمانی که به اینترنت متصل است
                .setRequiresBatteryNotLow(true) // زمانی که باتری کم نیست
                .build()
